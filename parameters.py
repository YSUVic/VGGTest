...
def args_parser():
    ...
    parser.add_argument('--distribution_type', type=str, default='NIID', help='IID / NIID_1 / NIID_2 / NIID_12')
    parser.add_argument('--batchsize', type=int, default=128, help='Dataset batch size')
